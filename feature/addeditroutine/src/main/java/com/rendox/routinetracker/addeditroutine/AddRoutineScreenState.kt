package com.rendox.routinetracker.addeditroutine
...
import com.rendox.routinetracker.addeditroutine.navigation.navigate
import com.rendox.routinetracker.addeditroutine.navigation.yesNoHabitDestinations
import com.rendox.routinetracker.addeditroutine.routinetype.ChooseRoutineTypePageState
import com.rendox.routinetracker.addeditroutine.routinetype.RoutineTypeUi
import com.rendox.routinetracker.addeditroutine.schedulepicker.ChooseSchedulePageState
import com.rendox.routinetracker.addeditroutine.schedulepicker.assembleSchedule
import com.rendox.routinetracker.addeditroutine.setgoal.SetGoalPageState
import com.rendox.routinetracker.addeditroutine.tweakroutine.TweakRoutinePageState
    ...
    init {
        ...
        navigateBackButtonText = when (navBackStackEntry?.destination?.route) {
            navDestinations.first().route -> UiText.StringResource(
                resId = com.rendox.routinetracker.feature.addeditroutine.R.string.discard_habit_creation,
            )
